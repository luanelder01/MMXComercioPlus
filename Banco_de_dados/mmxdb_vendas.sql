...
CREATE TABLE `vendas` (
  ...
  `id_operador_caixa` int DEFAULT NULL,
  `valor_total` decimal(10,2) NOT NULL,
  `data_venda` date NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_cliente` (`id_cliente`),
  KEY `id_operador_caixa` (`id_operador_caixa`),
  CONSTRAINT `vendas_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `clientes` (`id`),
  CONSTRAINT `vendas_ibfk_2` FOREIGN KEY (`id_operador_caixa`) REFERENCES `usuarios` (`id`)
...
-- Dump completed on 2024-02-01 22:06:42
